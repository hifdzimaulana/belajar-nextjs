    ...
    <>
      ...
      <div>
        ...
        <p className={styles["text"]}>
          ...
          suscipit! Natus, laboriosam. Esse fugit aperiam cupiditate officia
          nihil ab odit commodi quaerat nobis sit?
        </p>
        <p className={styles["text"]}>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Deserunt non
          voluptatibus, consectetur possimus aliquid quod asperiores
          perspiciatis est? Veritatis, quasi beatae! Fugiat itaque atque iure
          nesciunt officiis explicabo, tenetur quasi!
        </p>
        <Link href={"/other"}>
